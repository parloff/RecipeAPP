...
/*CONTROLLER.JS---This code appears to be a part of a larger application that manages recipes,
 bookmarks, and search functionality---*/ //CONTROL RECIPE SECTION///
...
Loads and renders the selected recipe */ const controlRecipes = async function() {
    try {
...
Renders search results and pagination buttons.*/ const controlSearchResults = async function() {
    try {
...
Renders new pagination buttons.*/ const controlPagination = function(goToPage) {
...
Updates the recipe view with the new servings.*/ const controlServings = function(newServings) {
...
Renders the bookmarks view.*/ const controlAddBookmark = function() {
...
/*Renders the bookmarks view. */ const controlBookmarks = function() {
    (0, _bookmarksViewJsDefault.default).render(_modelJs.state.bookmarks);
};
...
Closes the form window after a delay. */ const controlAddRecipe = async function(newRecipe) {
    try {
...
Calls the init function to initialize the application. */ const init = function() {
...
/*Takes data from a recipe.
Returns a simplified object with relevant recipe information. */ const createRecipeObject = function(data) {
...
/*persistBookmarks():
Saves the bookmarks to the local storage. */ const persistBookmarks = function() {
...
init(); //Initializes the application by loading bookmarks from local storage.
...
const KEY = "a1837298-9120-42fe-b7f4-763f1459c348";
const MODAL_CLOSE_SEC = 2.5; //API URL, TIMEOUT SEC, PERPAGE(SHOWING 10PAGES PER CLICK), API KEY GENERATED,
...
Used to set a timeout for the AJAX request. */ const timeout = function(s) {
...
let Fraction = require("3576f30874f27c2c");
/*. The purpose of this class is to manage the user interface for displaying a detailed view of a recipe */ class RecipeView extends (0, _viewJsDefault.default) {
...
},{"./View.js":"5cUXS","url:../../img/icons.svg":"loVOp","3576f30874f27c2c":"awG7q","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5cUXS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
},{}],"awG7q":[function(require,module,exports) {
...
if (0, module.exports) module.exports = Fraction;

},{}],"9OQAM":[function(require,module,exports) {
//SearchView class responsible for managing the user interface related to search functionality/
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class SearchView {
...
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
/*The purpose of this class is to manage the user interface for displaying search results.  */ class ResultsView extends (0, _viewJsDefault.default) {
...
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
/* The purpose of this class is to generate HTML markup for previewing a recipe. */ class PreviewView extends (0, _viewJsDefault.default) {
    _parentElement = "";
    _generateMarkup() {
        const id = window.location.hash.slice(1);
        return `
...
var _iconsSvg = require("url:../../img/icons.svg"); // Parcel 2
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
/* The purpose of this class is to manage the user interface for displaying pagination buttons.*/ class PaginationView extends (0, _viewJsDefault.default) {
...
var _iconsSvg = require("url:../../img/icons.svg"); // Parcel 2
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
/*The purpose of this class is to manage the user interface for displaying a list of bookmarked recipes. */ class BookmarksView extends (0, _viewJsDefault.default) {
...
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
/*AddRecipeView class is responsible for handling the user interface related to adding a new recipe */ class AddRecipeView extends (0, _viewJsDefault.default) {
...
},{"./View.js":"5cUXS","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["kYpTN","aenu9"], "aenu9", "parcelRequire7e89")
